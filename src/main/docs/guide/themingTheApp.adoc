...
[source,groovy]
./grails-app/vaadin/demo/VaadinGrailsUI.groovy
----
include::{sourceDir}/grails-app/vaadin/demo/VaadinGrailsUI.groovy[indent=0,tag=themeTag]
----
...
----
include::{sourceDir}/src/main/webapp/VAADIN/themes/vaadin-grails-theme/vaadin-grails-theme.scss[indent=0,tag=customCss]
----
